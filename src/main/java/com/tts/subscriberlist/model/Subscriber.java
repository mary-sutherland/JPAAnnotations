...
public class Subscriber {
	...
	@Id
	//Generated Value tells spring there will be an automated shift to the Id
	//GenerationType.AUTO - specifies that out ID will be automatically generated
	...
	@Column
	//an automatically created marking of date of when the user signs up
	@CreationTimestamp
